...
// import { getStacks, deleteStack, updateTheStackName } from "../../store/stacks";
          ...
          {selectedCard && (
            <div className="edit-stack-control-container">
              <div className="control-panel">
                <button onClick={editTheCard} id="special-button">
                  Edit card
                </button>
                <button onClick={deleteTheCard} id="special-button">
                  Delete card
                </button>
              </div>
          ...
          <div className="stack-card">
            <div className="stack-card-container">
              ...
              <div className="card-buttons">
                <button onClick={newCard} id="special-button">
                  New card
                </button>
                <button
                  onClick={(e) => setEditStackNameActive(true)}
                  id="special-button"
                >
                  Edit stack name
                </button>
                <button onClick={deleteEntireStack} id="special-button">
                  Delete stack
                </button>
              </div>
              <form hidden={!editStackNameActive}>
                <input onChange={updateStackName}></input>
                <button onClick={updateEntireStackName}>
                  Update stack name
                </button>
              </form>
              <div className="edit">{newCardActive && newCardFields()}</div>
